...
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#3b3528");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#3b3528");
  document.getElementById('CB').style.backgroundColor = "#3b3528";
});    
//base vermelha
...
document.getElementById('cor9').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#334c41");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#334c41");
  document.getElementById('CB').style.backgroundColor = "#334c41";
});  
...
document.getElementById('cor13').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#2c2e42");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#2c2e42");
  document.getElementById('CB').style.backgroundColor = "#2c2e42";
});  

document.getElementById('cor14').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#333e61");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#333e61");
  document.getElementById('CB').style.backgroundColor = "#333e61";
});  

document.getElementById('cor15').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#7b9fcb");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#7b9fcb");
  document.getElementById('CB').style.backgroundColor = "#7b9fcb";
});  
...
document.getElementById('cor17').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#9c8a6b");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#9c8a6b");
  document.getElementById('CB').style.backgroundColor = "#9c8a6b";
});  
...
document.getElementById('cor22').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#eee41d");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#eee41d");
  document.getElementById('CB').style.backgroundColor = "#eee41d";
});  
